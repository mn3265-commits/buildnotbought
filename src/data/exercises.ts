...
const META: Record<number, { role: Role; alts: Alt[] }> = {
  1: {
    role: 'key',
    alts: [
      { n: 'Dumbbell Bench Press', w: 'Shoulder-friendly, no spotter needed', ratio: 0.4, inc: 2 },
      { n: 'Machine Chest Press', w: 'Safe to push near failure', ratio: 1.071, inc: 2.5 },
      { n: 'Weighted Push-up', w: 'No equipment / travelling', ratio: 0.214, inc: 2.5 },
    ],
  },
  2: {
    role: 'main',
    alts: [
      { n: 'Seated DB Shoulder Press', w: 'Easier on the lower back', ratio: 0.412, inc: 1 },
      { n: 'Machine Shoulder Press', w: 'Stability handled for you', ratio: 1.059, inc: 2.5 },
      { n: 'Arnold Press', w: 'Extra front-delt range', ratio: 0.376, inc: 1 },
    ],
  },
  3: {
    role: 'accessory',
    alts: [
      { n: 'Incline Barbell Press', w: 'Heavier loading', ratio: 2.115, inc: 2.5 },
      { n: 'Incline Machine Press', w: 'Fixed, guided path', ratio: 2.308, inc: 2.5 },
      { n: 'Low-to-High Cable Fly', w: 'Constant tension', ratio: 0.538, inc: 1 },
    ],
  },
  4: {
    role: 'accessory',
    alts: [
      { n: 'Overhead Cable Extension', w: 'Stretches the long head', ratio: 0.846, inc: 2.5 },
      { n: 'Skull Crushers', w: 'Free-weight option', ratio: 0.769, inc: 2.5 },
      { n: 'Bench Dips', w: 'Bodyweight, no cable', ratio: 0.308, inc: 2.5 },
    ],
  },
  5: {
    role: 'accessory',
    alts: [
      { n: 'Cable Lateral Raise', w: 'Tension at the bottom', ratio: 0.643, inc: 1 },
      { n: 'Machine Lateral Raise', w: 'Strictest form', ratio: 1.143, inc: 2 },
      { n: 'Upright Row', w: 'Compound side-delt hit', ratio: 2.143, inc: 2.5 },
    ],
  },
  6: {
    role: 'key',
    alts: [
      { n: 'Trap-Bar Deadlift', w: 'Kinder on the lower back', ratio: 1.083, inc: 5 },
      { n: 'Rack Pull', w: 'Shorter range, heavier', ratio: 1.167, inc: 5 },
      { n: 'Romanian Deadlift', w: 'More hamstring focus', ratio: 0.75, inc: 5 },
    ],
  },
  7: {
    role: 'main',
    alts: [
      { n: 'Lat Pulldown', w: 'Scale the load exactly', ratio: 3.667, inc: 2.5 },
      { n: 'Assisted Pull-up', w: 'Build up to bodyweight', ratio: 0.533, inc: 2 },
      { n: 'Chin-up', w: 'More biceps involvement', ratio: 0.8, inc: 2.5 },
    ],
  },
  8: {
    role: 'main',
    alts: [
      { n: 'Dumbbell Row', w: 'One arm at a time', ratio: 0.431, inc: 2 },
      { n: 'Chest-Supported Row', w: 'No lower-back strain', ratio: 0.923, inc: 2.5 },
      { n: 'Seated Cable Row', w: 'Constant tension', ratio: 1, inc: 2.5 },
    ],
  },
  9: {
    role: 'accessory',
    alts: [
      { n: 'Pull-up', w: 'Bodyweight version', ratio: 0.182, inc: 2.5 },
      { n: 'Straight-Arm Pulldown', w: 'Isolates the lats', ratio: 0.455, inc: 2.5 },
      { n: 'Machine Pulldown', w: 'Fixed path', ratio: 1.055, inc: 2.5 },
    ],
  },
  10: {
    role: 'accessory',
    alts: [
      { n: 'Dumbbell Curl', w: 'Even out both arms', ratio: 0.436, inc: 1 },
      { n: 'Cable Curl', w: 'Constant tension', ratio: 0.909, inc: 2 },
      { n: 'Preacher Curl', w: 'Strict, no swinging', ratio: 0.818, inc: 2.5 },
    ],
  },
  11: {
    role: 'key',
    alts: [
      { n: 'Front Squat', w: 'Quad focus, easier on back', ratio: 0.8, inc: 5 },
      { n: 'Hack Squat', w: 'Machine stability', ratio: 1.1, inc: 5 },
      { n: 'Goblet Squat', w: 'Beginner / at home', ratio: 0.28, inc: 2 },
    ],
  },
  12: {
    role: 'main',
    alts: [
      { n: 'Lying Leg Curl', w: 'Isolates the hamstrings', ratio: 0.467, inc: 2.5 },
      { n: 'Good Morning', w: 'Same hip-hinge pattern', ratio: 0.5, inc: 2.5 },
      { n: 'Dumbbell RDL', w: 'Lighter loading', ratio: 0.356, inc: 2 },
    ],
  },
  13: {
    role: 'accessory',
    alts: [
      { n: 'Hack Squat', w: 'More quad emphasis', ratio: 0.611, inc: 5 },
      { n: 'Bulgarian Split Squat', w: 'Single-leg / at home', ratio: 0.111, inc: 2 },
      { n: 'Goblet Squat', w: 'No machine needed', ratio: 0.156, inc: 2 },
    ],
  },
  14: {
    role: 'accessory',
    alts: [
      { n: 'Lying Leg Curl', w: 'Different angle', ratio: 0.933, inc: 2.5 },
      { n: 'Nordic Curl', w: 'Bodyweight, brutal', ratio: 0.056, inc: 2.5 },
      { n: 'Romanian Deadlift', w: 'Hip-hinge option', ratio: 2, inc: 5 },
    ],
  },
  15: {
    role: 'accessory',
    alts: [
      { n: 'Seated Calf Raise', w: 'Targets the soleus', ratio: 0.786, inc: 5 },
      { n: 'Leg-Press Calf Raise', w: 'Use the leg press', ratio: 1.714, inc: 10 },
      { n: 'Single-Leg Calf Raise', w: 'No machine needed', ratio: 0.143, inc: 2.5 },
    ],
  },
}
...
const BASE: Omit<Exercise, 'role' | 'alts'>[] = [
  {
    ...
    scheme: '4 × 6–8', inc: 2.5, start: 50, current: 70, goal: 90, tempo: [3, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '4 × 6–8', inc: 2.5, start: 30, current: 42.5, goal: 55, tempo: [2, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 8–10', inc: 2, start: 18, current: 26, goal: 34, tempo: [3, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 10–12', inc: 2.5, start: 20, current: 32.5, goal: 45, tempo: [2, 0, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 12–15', inc: 1, start: 8, current: 14, goal: 20, tempo: [2, 0, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 5', inc: 5, start: 80, current: 120, goal: 160, tempo: [2, 0, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '4 × 6–8', inc: 2.5, start: 0, current: 15, goal: 30, tempo: [3, 0, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '4 × 8', inc: 2.5, start: 40, current: 65, goal: 85, tempo: [2, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 10–12', inc: 2.5, start: 35, current: 55, goal: 70, tempo: [2, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 8–10', inc: 2.5, start: 15, current: 27.5, goal: 40, tempo: [3, 0, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '4 × 6', inc: 5, start: 60, current: 100, goal: 140, tempo: [3, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 8–10', inc: 5, start: 50, current: 90, goal: 120, tempo: [3, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 10–12', inc: 10, start: 100, current: 180, goal: 260, tempo: [2, 1, 1],
    cues: [
  ...
  },
  {
    ...
    scheme: '3 × 12–15', inc: 2.5, start: 25, current: 45, goal: 60, tempo: [2, 1, 2],
    cues: [
  ...
  },
  {
    ...
    scheme: '4 × 12–15', inc: 5, start: 40, current: 70, goal: 95, tempo: [2, 1, 1],
    cues: [
